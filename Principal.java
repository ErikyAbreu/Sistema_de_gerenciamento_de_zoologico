		  ...
		  switch(T1) {
		  	case 1:
		  		...
		  		case 1:
		  			...
		  			A.AddAnimal(new Anfibios(Double.parseDouble(JOptionPane.showInputDialog(null,"INFORME O PESO DO ANFÍBIO: ","ANFÍBIOS",JOptionPane.INFORMATION_MESSAGE)), 
		  						...
		  						new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O NÚMERO DA JAULA DO ANFÍBIO: ","ANFÍBIOS", JOptionPane.INFORMATION_MESSAGE)), 2), 
		  						Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O ID DO ANFÍBIO: ","ANFÍBIOS", JOptionPane.INFORMATION_MESSAGE))));

		  			break;
		  						
		  			case 2:
		  				A.AddAnimal(new Aves(Double.parseDouble(JOptionPane.showInputDialog(null,"INFORME O PESO DA AVE: ","AVES", JOptionPane.INFORMATION_MESSAGE)),
		  						...
		  						JOptionPane.showInputDialog(null,"NOME DA AVE: ","AVES", JOptionPane.INFORMATION_MESSAGE), 
									new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O NÚMERO DA JAULA DA AVE: ","AVES", JOptionPane.INFORMATION_MESSAGE)), 3),  
		  				...
		  				break;
		  			case 3:
		  				A.AddAnimal(new Mamifero(Double.parseDouble(JOptionPane.showInputDialog(null,"INFORME O PESO DO MAMÍFERO:: ","MAMÍFEROS", JOptionPane.INFORMATION_MESSAGE)),
		  						...
		  						JOptionPane.showInputDialog(null,"NOME DO MAMÍFERO: ","MAMÍFEROS", JOptionPane.INFORMATION_MESSAGE), 
									new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O NÚMERO DA JAULA DO MAMÍFERO: ","MAMÍFEROS", JOptionPane.INFORMATION_MESSAGE)), 4),  
		  				...
		  				break;
		  			case 4:
		  				A.AddAnimal(new Peixes(Double.parseDouble(JOptionPane.showInputDialog(null,"INFORME O PESO DO PEIXE: ","PEIXE", JOptionPane.INFORMATION_MESSAGE)),
		  						...
		  						JOptionPane.showInputDialog(null,"NOME DO PEIXE: ","PEIXE", JOptionPane.INFORMATION_MESSAGE), 
									new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O NÚMERO DO AQUARIO DO PEIXE: ","PEIXE", JOptionPane.INFORMATION_MESSAGE)), 5),  
		  				...
		  				break;
		  			case 5:
		  				A.AddAnimal(new Repteis(Double.parseDouble(JOptionPane.showInputDialog(null,"INFORME O PESO DO RÉPTIL: ","RÉPTEIS", JOptionPane.INFORMATION_MESSAGE)),
		  						...
		  						JOptionPane.showInputDialog(null,"NOME DO RÉPTIL: ","RÉPTEIS", JOptionPane.INFORMATION_MESSAGE), 
									new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME O NÚMERO DA JAULA DO RÉPTIL: ","RÉPTEIS", JOptionPane.INFORMATION_MESSAGE)), 6), 
		  	...
		  	TF = Integer.parseInt(JOptionPane.showInputDialog(null, "DIGITE:\n1-ADICIONAR FUNCIONÁRIO\n2-REMOVER FUNCIONÁRIO\n3-IMPRIMIR FUNCIONÁRIO \n4-IMPRIMIR TODOS FUNCIONÁRIOS\n5-CALCULAR SALÁRIO DO FUNCIONÁRIO","MENU FUNCIONÁRIOS", JOptionPane.INFORMATION_MESSAGE));
		  			...
		  			case 1:
			  			...
			  			switch (TF2) {
			  			case 1:
			  			F.addFuncionario(new Gerente(JOptionPane.showInputDialog(null,"NOME DO GERENTE: ","GERENTE", JOptionPane.INFORMATION_MESSAGE), 
			  						...
			  						new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME A SALA DO GERENTE: ","GERENTE", JOptionPane.INFORMATION_MESSAGE)), 1))); 
			  			break;
			  						
			  			case 2:
			  			F.addFuncionario(new Veterinario(JOptionPane.showInputDialog(null,"NOME DO VETERINÁRIO: ","VETERINÁRIO", JOptionPane.INFORMATION_MESSAGE), 
			  						...
			  						new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME A SALA DO VETERINÁRIO: ","VETERINÁRIO", JOptionPane.INFORMATION_MESSAGE)), 1),
			  						250,
			  			...
			  			break;
			  			case 3:
			  			F.addFuncionario(new Zelador(JOptionPane.showInputDialog(null,"NOME DO ZELADOR: ","ZELADOR", JOptionPane.INFORMATION_MESSAGE), 
			  						...
			  						new Local(Integer.parseInt(JOptionPane.showInputDialog(null,"INFORME A SALA DO ZELADOR: ","ZELADOR", JOptionPane.INFORMATION_MESSAGE)), 1))); 
			  			break;
			  			default:
							JOptionPane.showMessageDialog(null, "OPÇÃO INVÁLIDA! TENTE NOVAMENTE.");
							break;
